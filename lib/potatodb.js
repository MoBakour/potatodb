 ...
 */
const setRoot = (rootPath, rootName = "databases") => {
...
class PotatoDB {
     ...
     * @param {{id?: boolean, timestamps?: boolean}} [options] Farm options.
     *
     * id option defines whether potato documents should include _id string fields.
     *
     ...
     */
    createFarm(farmName, { id = true, timestamps = false } = {}) {
        ...
        return new Farm(farmName, farmPath, this.dbName, id, timestamps);
    }
