...
class Farm {
    ...
    /**
     * @typedef {Object} PostInterceptorOptions
     * @property {number} [limit] Defines the maximum number of returned potato documents.
     * @property {Object | Function} [sort] Sorting object or function.
     ...
     * @param {PostInterceptorOptions} [options] Options object.
     ...
     * @property {Object} [sort] Sorting object or function.
     * @property {Object} [select] Selection object to specify fields to include or exclude.
     * @property {Object} [populate] Population object to fill references fields.
     */
     ...
     * @param {InsertOneOptions | InsertManyOptions} [options] Options object.
     * @returns {Promise<Object | Object[]>} The inserted potato document or the array of inserted potato documents.
     */
    async #insertLogic(caller, newData, options) {
        try {
            // validation
            ...
            return Farm.#postInterceptor(caller, newData, options);
        } catch (err) {
     ...
     * @param {InsertOneOptions} [options] Options object.
     * @returns {Promise<Object>} The potato document inserted.
     */
    async insertOne(newData, options) {
        return await this.#insertLogic("insertOne", newData, options);
    }
     ...
     * @param {InsertManyOptions} [options] Options object.
     * @returns {Promise<Object[]>} An array of the inserted potato documents.
     */
    async insertMany(newData, options) {
        return await this.#insertLogic("insertMany", newData, options);
    }
     ...
     * @param {Object | Function} [test] A query object or a test function.
     * @param {FindOneOptions | FindManyOptions} [options] Options object.
     ...
     * @async
     * @param {Object | Function} [test] A query object or a test function.
     * @param {FindOneOptions} [options] The options object.
     ...
     * @async
     * @param {Object | Function} [test] A query object or a test function.
     * @param {FindManyOptions} [options] The options object.
    ...
    /**
     * @typedef {Object} UpdateOneOptions
     * @property {Object} [select] Selection object to specify fields to include or exclude.
     * @property {Object} [populate] Population object to fill references fields.
    ...
    /**
     * @typedef {Object} UpdateManyOptions
     * @property {Object | Function} [sort] Sorting object or function.
     * @property {Object} [select] Selection object to specify fields to include or exclude.
     * @property {Object} [populate] Population object to fill references fields.
     * @property {boolean} [updated=true] Specifies whether the returned potato document should be the pre-updated or the post-updated version.
     ...
     * @param {UpdateOneOptions | UpdateManyOptions} [options] Options object.
     ...
     * @param {UpdateOneOptions} [options] Options object.
     ...
     * @param {Object | Function} test A query object or a test function.
     * @param {Object | Function} updates An update object or update function.
     * @param {UpdateManyOptions} [options] Options object.
    ...
    /**
     * @typedef {Object} DeleteOneOptions
     * @property {Object} [select] Selection object to specify fields to include or exclude.
     * @property {Object} [populate] Population object to fill references fields.
     */

    /**
     * @typedef {Object} DeleteManyOptions
     * @property {Object | Function} [sort] Sorting object or function.
     * @property {Object} [select] Selection object to specify fields to include or exclude.
     * @property {Object} [populate] Population object to fill references fields.
     */
     ...
     * @param {Object | Function} [test] A query object or a test function.
     * @param {DeleteOneOptions | DeleteManyOptions} [options] Options object.
     ...
     * @async
     * @param {Object | Function} [test] A query object or a test function.
     * @param {DeleteOneOptions} [options] Options object.
     ...
     * @async
     * @param {Object | Function} [test] A query object or a test function.
     * @param {DeleteManyOptions} [options] Options object.
